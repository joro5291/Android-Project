...
import com.ifcompany.tinder.DBKey.Companion.DIS_LIKE
import com.ifcompany.tinder.DBKey.Companion.LIKE
...
import com.ifcompany.tinder.DBKey.Companion.USER_ID
...
class LikeActivity : AppCompatActivity(), CardStackListener {
    ...
    private fun disLike() {
        ...
        messageShow("${card.name}님을 disLike 하셨습니다.")
    }
    ...
    private fun like() {
        ...
        saveMathchIfOtherUserLikedMe(card.userId)
        // todo 매칭이 된 시점을 봐야한다.
        messageShow("${card.name}님을 Like 하셨습니다.")
    }

    private fun saveMathchIfOtherUserLikedMe(otherUserId: String) {
